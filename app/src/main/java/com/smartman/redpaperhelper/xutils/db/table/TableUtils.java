...
import com.smartman.redpaperhelper.xutils.db.annotation.Table;
...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, com.smartman.redpaperhelper.xutils.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.smartman.redpaperhelper.xutils.db.table.Id>();

    /* package */
    static synchronized com.smartman.redpaperhelper.xutils.db.table.Id getId(Class<?> entityType) {
        ...
        com.smartman.redpaperhelper.xutils.db.table.Id id = new com.smartman.redpaperhelper.xutils.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.smartman.redpaperhelper.xutils.db.table.Id id = getId(entityType);
